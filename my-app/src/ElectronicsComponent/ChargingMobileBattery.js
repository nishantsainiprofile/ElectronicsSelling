...
function ChargingMobileBattery() {
  ...
  const firstSetFields = [
    ...
    { label: "Standing Screen Display Size", name: "StandingScreenDisplaySize" },
  ...
  return (
    <div>
      {LoginState ? (
        <div className="grid-container">
          <div className="grid-x grid-padding-x align-center">
            ...
            <button
              ...
              <h2 className="text-center">Upload Mobile Charger Information</h2>
        ...
        <div>
          <p className="text-center">Please login before uploading a Mobile Charger</p>
          <Login />
        </div>
      )}
    </div>
...
export default ChargingMobileBattery;
